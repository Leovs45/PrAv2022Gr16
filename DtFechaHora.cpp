...
//Estos serían los métodos de las operaciones
...
ostream& operator <<(ostream& salida,const DtFechaHora& fechahora){
  cout << "\tMinuto: " << fechahora.minuto << "\n\tHora: " << fechahora.hora << "\n\tDía: " << fechahora.dia << "\n\tMes: " << fechahora.mes << "\n\tAño: " << fechahora.anio << endl;
  return salida;
}